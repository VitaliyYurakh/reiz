...
import {auth, documentUpload, validateDocFile, requirePermission} from '../middleware';
...
router.post('/:id/document', auth, requirePermission('clients', 'full'), documentUpload, validateDocFile, clientController.uploadDocument);
