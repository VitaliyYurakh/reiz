...
// Rate plans
router.get('/rate-plan', auth, pricingController.getAllRatePlans.bind(pricingController));
...
// Add-ons
router.get('/add-on', auth, pricingController.getAllAddOns.bind(pricingController));
...
router.get(
    '/coverage-package',
    auth,
    pricingController.getAllCoveragePackages.bind(pricingController)
);
