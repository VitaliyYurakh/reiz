  ...
  const links = [
    { href: "/", label: asideT("home") },
    {
      ...
      subLinks: [
        ...
        { href: "/rental/uzhhorod", label: asideT("cars_link10") },
        { href: "/rental/vinnytsia", label: asideT("cars_link11") },
        { href: "/rental/mukachevo", label: asideT("cars_link12") },
        { href: "/rental/chernivtsi", label: asideT("cars_link13") },
        { href: "/rental/poltava", label: asideT("cars_link14") },
