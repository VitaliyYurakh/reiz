  ...
  return (
    <div className="cert-content">
      ...
      <form className="cert">
        ...
        <div className="cert__hero-group">
          <nav
            className="cert-mobile-breadcrumbs"
            aria-label={t("breadcrumbs.current")}
          >
            <Link
              href={getDefaultPath("home")}
              className="cert-mobile-breadcrumbs__link cert-mobile-breadcrumbs__home"
            >
              <HomeIcon />
            </Link>
            <span className="cert-mobile-breadcrumbs__dot" />
            <span className="cert-mobile-breadcrumbs__current">
          ...
          >
            <h1 className="cert__hero-title">
              <span className="cert__hero-title-accent">
                {t("hero.titleAccent")}
              </span>{" "}
              <span className="cert__hero-title-nowrap">
                {t("hero.titleRest")}
              </span>
            </h1>
        ...
        >
          ...
          <div className="cert__image">
            <UiImage
              width={480}
              height={600}
              src="/img/certificate/gift-card.webp"
