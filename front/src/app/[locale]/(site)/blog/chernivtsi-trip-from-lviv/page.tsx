...
const PATH = "/blog/chernivtsi-trip-from-lviv";
const IMAGE = "/img/blog/chernivtsi-trip-centered-v3.webp";
...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: "blogChernivtsiTripFromLviv",
  });
...
export default async function ChernivtsiTripFromLvivPage() {
  const t = await getTranslations("blogChernivtsiTripFromLviv");
    ...
    <article className="article-section__inner" aria-labelledby="article-title">
      ...
      <div className="article__content">
        ...
        <div className="article__rental-box">
          ...
          <Link href="/rental/chernivtsi" className="main-button">
            {t("rental_box.cta")}
          </Link>
        </div>
