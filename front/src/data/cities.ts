...
> = {
  kyiv: {
    uk: {
      ...
      ogDescription:
        "Оренда та прокат авто у Києві від REIZ: Економ, Комфорт, SUV і бізнес-клас. Подача за адресою або до вокзалу, прозорі умови оренди.",
      footerDescription:
        "Надійний прокат авто в Києві від REIZ. Економ, Комфорт та SUV з подачею за адресою в межах міста. Умови й час подачі підтвердить менеджер.",
    },
    ru: {
      ...
      ogDescription:
        "Аренда и прокат авто в Киеве от REIZ: Эконом, Комфорт, SUV и бизнес-класс. Подача по адресу или к вокзалу, прозрачные условия аренды.",
      footerDescription:
        "Надежный прокат авто в Киеве от REIZ. Эконом, Комфорт и SUV с подачей по адресу в пределах города. Условия и время подачи подтвердит менеджер.",
    },
    en: {
  ...
  ternopil: {
    uk: {
      ...
      subtitle:
        "Прокат авто у Тернополі без застави. Подача на вокзал, автостанцію або за адресою. Економ та бізнес-клас.",
    ...
    ru: {
      ...
      subtitle:
        "Прокат авто в Тернополе без залога. Подача на вокзал, автостанцию или по адресу. Эконом и бизнес-класс.",
  ...
  odesa: {
    uk: {
      ...
      subtitle:
        "Прокат авто в Одесі без застави. Подача за адресою, у центр, Аркадію або до вокзалу. Кабріолети та позашляховики.",
      address: "Міжнародний аеропорт «Одеса» (ODS)",
      ogTitle: "Оренда та прокат авто в Одесі без застави | REIZ",
      ogDescription:
        "Оренда та прокат авто в Одесі від REIZ: Економ, Комфорт, SUV і бізнес-клас. Подача за адресою, у центр або Аркадію, прозорі умови.",
      footerDescription:
        "Оренда машин в Одесі для відпочинку та справ. Доступні авто Економ класу та позашляховики. Подача за адресою або до вокзалу — за попереднім узгодженням.",
    },
    ru: {
      ...
      subtitle:
        "Прокат авто в Одессе без залога. Подача по адресу, в центр, Аркадию или к вокзалу. Кабриолеты и внедорожники.",
      address: "Международный аэропорт «Одесса» (ODS)",
      ogTitle: "Аренда и прокат авто в Одессе без залога | REIZ",
      ogDescription:
        "Аренда и прокат авто в Одессе от REIZ: Эконом, Комфорт, SUV и бизнес-класс. Подача по адресу, в центр или Аркадию, прозрачные условия.",
      footerDescription:
        "Аренда машин в Одессе для отдыха и дел. Доступны авто Эконом класса и внедорожники. Подача по адресу или к вокзалу — по предварительному согласованию.",
    },
    en: {
  ...
  dnipro: {
    uk: {
      ...
      subtitle:
        "Прокат авто у Дніпрі без застави для ділових поїздок. Подача за адресою в межах міста. Бізнес-клас та довгострокова оренда.",
      footerDescription:
    ...
    ru: {
      ...
      subtitle:
        "Прокат авто в Днепре без залога для деловых поездок. Подача по адресу в пределах города. Бизнес-класс и долгосрочная аренда.",
      footerDescription:
  ...
  kharkiv: {
    uk: {
      ...
      subtitle:
        "Прокат авто у Харкові без застави. Подача на вокзал або за адресою. Бізнес та SUV-клас.",
      footerDescription:
    ...
    ru: {
      ...
      subtitle:
        "Прокат авто в Харькове без залога. Подача на вокзал или по адресу. Бизнес и SUV-класс.",
      footerDescription:
  ...
  "ivano-frankivsk": {
    uk: {
      ...
      subtitle:
        "Прокат авто в Івано-Франківську без застави. Подача за адресою та виїзд до Карпат. Позашляховики та седани.",
      address: "Міжнародний аеропорт «Івано-Франківськ» (IFO)",
      footerDescription:
        "Автопрокат в Івано-Франківську. Зручний старт для подорожі в Карпати. В наявності Економ та джипи 4x4. Подача за адресою або до вокзалу — за попереднім узгодженням.",
    ...
    ru: {
      ...
      subtitle:
        "Прокат авто в Ивано-Франковске без залога. Подача по адресу и выезд в Карпаты. Внедорожники и седаны.",
      address: "Международный аэропорт «Ивано-Франковск» (IFO)",
      footerDescription:
        "Автопрокат в Ивано-Франковске. Удобный старт для путешествия в Карпаты. В наличии Эконом и джипы 4x4. Подача по адресу или к вокзалу — по предварительному согласованию.",
  ...
  chernivtsi: {
    uk: {
      ...
      subtitle:
        "Оренда авто у Чернівцях — авто для подорожей Буковиною, містом і Карпатами.",
    ...
    ru: {
      ...
      subtitle:
        "Аренда авто в Черновцах — автомобили для поездок по Буковине, городу и Карпатам.",
  ...
  lutsk: {
    uk: {
      ...
      subtitle:
        "Прокат авто у Луцьку без застави. Подача по місту та на вокзал. Поїздки Волинню й до Шацьких озер.",
      footerDescription:
    ...
    ru: {
      ...
      h1: "Аренда авто в Луцке — подача по городу и поездки по Волыни",
      sectionCars: "АВТОМОБИЛИ REIZ В ЛУЦКЕ",
      sectionWelcome: "ДОБРО ПОЖАЛОВАТЬ В REIZ ЛУЦК",
      subtitle:
        "Прокат авто в Луцке без залога. Подача по городу и на вокзал. Поездки по Волыни и к Шацким озёрам.",
      footerDescription:
...
export function getCityFooterAddress(
  ...
  const airportLabelPattern = /аеропорт|аэропорт|airport|lotnisko|aeroport/i;

  // Airport pickup is currently unavailable in Ukraine. Do not surface stale
  // airport labels in the hero or footer, even while older city copy is being
  // reviewed separately.
  if (cityData?.address && !airportLabelPattern.test(cityData.address)) {
    return cityData.address;
  }

  const cityName = city.localized[locale].name;
  const templates: LocalizedField = {
    uk: `${cityName}: подача за адресою в межах міста`,
    ru: `${cityName}: подача по адресу в пределах города`,
    en: `${cityName}: delivery to an address within the city`,
    pl: `${cityName}: dostawa pod adres w granicach miasta`,
    ro: `${cityName}: livrare la adresă în oraș`,
  };
