...
> = {
  kyiv: {
    uk: {
      title: "Оренда авто у Києві без застави — подача в Бориспіль 24/7",
      metaDescription:
        "Прокат авто у Києві від REIZ. Автопарк 2023–2025, подача в аеропорт Бориспіль, на вокзал та по місту. Без прихованих платежів, повне КАСКО. Бронюйте онлайн!",
      ...
      ogTitle: "Оренда авто у Києві без застави — подача в Бориспіль 24/7 | REIZ",
      ogDescription:
        "Прокат авто у Києві від REIZ. Автопарк 2023–2025, подача в аеропорт Бориспіль, на вокзал та по місту. Без прихованих платежів, повне КАСКО. Бронюйте онлайн!",
      footerDescription:
  ...
  odesa: {
    uk: {
      title: "Оренда авто в Одесі без застави — подача в аеропорт ODS",
      metaDescription:
        "Прокат авто в Одесі від REIZ. Подача в Аркадію, Центр, порт та аеропорт ODS. Автопарк 2023–2025, страховка включена. Бізнес, SUV та економ-клас. Бронюйте онлайн!",
      ...
      ogTitle: "Оренда авто в Одесі без застави — подача в аеропорт ODS | REIZ",
      ogDescription:
        "Прокат авто в Одесі від REIZ. Подача в Аркадію, Центр, порт та аеропорт ODS. Автопарк 2023–2025, страховка включена. Бізнес, SUV та економ-клас. Бронюйте онлайн!",
      footerDescription:
  ...
  dnipro: {
    uk: {
      title: "Оренда авто у Дніпрі без застави — бізнес та SUV клас",
      metaDescription:
        "Прокат авто у Дніпрі від REIZ. Позашляховики 4x4, бізнес-клас та економ. Подача в аеропорт DNK та по місту 24/7. Оплата з ПДВ для юросіб. Бронюйте онлайн!",
      ...
      ogTitle: "Оренда авто у Дніпрі без застави — бізнес та SUV клас | REIZ",
      ogDescription:
        "Прокат авто у Дніпрі від REIZ. Позашляховики 4x4, бізнес-клас та економ. Подача в аеропорт DNK та по місту 24/7. Оплата з ПДВ для юросіб. Бронюйте онлайн!",
    },
    ru: {
  ...
  kharkiv: {
    uk: {
      title: "Оренда авто у Харкові без застави — подача на вокзал 24/7",
      metaDescription:
        "Прокат авто у Харкові від REIZ. Подача на Південний вокзал, в аеропорт HRK та по місту. Економ, бізнес та SUV-клас. Страховка включена, гнучкі умови повернення.",
      ...
      ogTitle: "Оренда авто у Харкові без застави — подача на вокзал 24/7 | REIZ",
      ogDescription:
        "Прокат авто у Харкові від REIZ. Подача на Південний вокзал, в аеропорт HRK та по місту. Економ, бізнес та SUV-клас. Страховка включена, гнучкі умови повернення.",
    },
    ru: {
  ...
  "ivano-frankivsk": {
    uk: {
      title: "Оренда авто в Івано-Франківську без застави — Карпати та аеропорт IFO",
      metaDescription:
        "Прокат авто в Івано-Франківську від REIZ. Позашляховики 4x4 для Карпат, седани та економ-клас. Подача в аеропорт IFO, на вокзал та по місту 24/7. Офіційний договір.",
      ...
      ogTitle: "Оренда авто в Івано-Франківську без застави — Карпати та аеропорт IFO | REIZ",
      ogDescription:
        "Прокат авто в Івано-Франківську від REIZ. Позашляховики 4x4 для Карпат, седани та економ-клас. Подача в аеропорт IFO, на вокзал та по місту 24/7. Офіційний договір.",
    },
    ru: {
  ...
  zaporizhzhia: {
    uk: {
      title: "Оренда авто у Запоріжжі без застави — подача по місту 24/7",
      metaDescription:
        "Прокат авто у Запоріжжі від REIZ. Нові автомобілі 2023–2025, безкоштовна подача по місту та в аеропорт OZH. Економ та комфорт-клас. Офіційний договір. Бронюйте онлайн!",
      ...
      ogTitle: "Оренда авто у Запоріжжі без застави — подача по місту 24/7 | REIZ",
      ogDescription:
        "Прокат авто у Запоріжжі від REIZ. Нові автомобілі 2023–2025, безкоштовна подача по місту та в аеропорт OZH. Економ та комфорт-клас. Бронюйте онлайн!",
    },
    ru: {
