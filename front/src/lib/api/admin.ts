...
export const updateCountingRules = async (id: number, rules: { pricePercent: number; depositPercent: number; priceFixed?: number | null; priceFixed30?: number | null; depositFixed?: number | null }[]) => {
